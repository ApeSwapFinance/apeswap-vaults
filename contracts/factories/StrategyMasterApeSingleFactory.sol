...
contract StrategyMasterApeSingleFactory is Ownable {
  ...
  function deployDefaultMasterApeSingleStrategy(
    ...
    deployMasterApeSingleStrategy([defaultVaultChef, _configAddresses[0], defaultRouter, _configAddresses[1], _configAddresses[2], defaultGov], _pid, _earnedToWnativePath, _earnedToUsdcPath, _earnedToBananaPath);
  }
