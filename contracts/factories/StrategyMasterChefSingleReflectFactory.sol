...
import "../StrategyMasterChefSingleReflect.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract StrategyMasterChefSingleReflectFactory is Ownable {
  ...
  function deployMasterChefSingleStrategy(
      ...
      StrategyMasterChefSingleReflect strategy = new StrategyMasterChefSingleReflect();
