...
library Bytes {
    ...
    function equalsRef(bytes memory self, bytes memory other)
        internal
        pure
        returns (bool equal)
    {
    ...
    function substr(bytes32 self, uint8 startIndex)
        internal
        pure
        returns (bytes32)
    {
        require(startIndex < 32);
        return bytes32(uint256(self) << (startIndex * 8));
    }
    ...
    function toBytes(bytes32 self, uint8 len)
        internal
        pure
        returns (bytes memory bts)
    {
    ...
    function toBytes(uint256 self, uint16 bitsize)
        internal
        pure
        returns (bytes memory bts)
    {
    ...
    function highestByteSet(bytes32 self)
        internal
        pure
        returns (uint8 highest)
    {
        highest = 31 - lowestByteSet(uint256(self));
    }
    ...
    function lowestByteSet(bytes32 self) internal pure returns (uint8 lowest) {
        lowest = 31 - highestByteSet(uint256(self));
    }
    ...
    function highestByteSet(uint256 self)
        internal
        pure
        returns (uint8 highest)
    {
    ...
    // Requires that 'self != 0'
    // Uses little endian ordering (the least significant byte has index '0').
    function lowestByteSet(uint256 self) internal pure returns (uint8 lowest) {
        require(self != 0);
        uint256 ret;
